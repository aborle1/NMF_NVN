#Script to process tests for dirac3-experiment 2 (k =3 n =4 and m=5,6,7,8)
#For test set B
import numpy as np
...
for i in range(0,100):
    ...
    res_filepath = "./test_matrices/dirac3_exp2a/size_" + str(n) + "x" + str(m) + "/results/" + res_filename 
