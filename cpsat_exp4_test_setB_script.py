...
thread = 'mthread' #sthread for serial processing, mthread for parallel processing
objective = 'l1'
...
for i in range(0,1):
    ...
    #(We are also saving all the other solutions in the file, so nothing is lost)
    ...
    #Save it to a file
    print(objective,len(info['n_variables']))
